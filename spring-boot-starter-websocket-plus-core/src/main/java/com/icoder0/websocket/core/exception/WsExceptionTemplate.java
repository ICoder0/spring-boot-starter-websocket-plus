...
public class WsExceptionTemplate {
    ...
    public static final String REQUEST_PARAMETER_PAYLOAD_SPECIFICATION_ERROR;
    public static final String REQUEST_PARAMETER_PAYLOAD_PARAMS_SPECIFICATION_ERROR;
    ...
    static {
        ...
        REQUEST_PARAMETER_PAYLOAD_SPECIFICATION_ERROR           =       "检查payload规范 %s";

        REQUEST_PARAMETER_PAYLOAD_PARAMS_SPECIFICATION_ERROR    =       "检查payload#params规范 %s";
    }
}
